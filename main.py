...
### LEFT SIDE GPIO ###
buttonSolenoid = Pin(0, Pin.IN, None) # type: ignore
solenoid = Pin(1,Pin.OUT)
solenoid.off();

buttonESC = Pin(2, Pin.IN, None) # type: ignore
pwm = PWM(Pin(3))
pwm.freq(50)
...
rotary = RotaryIRQ(pin_num_clk = 18,                  # GPIO pin connected to encoder CLK pin
